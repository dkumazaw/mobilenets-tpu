...
def distorted_bounding_box_crop(image_bytes,
                                ...
                                aspect_ratio_range: tuple = (0.75, 1.33),
                                area_range: tuple = (0.05, 1.0),
    ...
    Args:
        ...
        min_object_covered (float):  The cropped area of the image 
                            must contain at least this fraction of any bounding box supplied.
        aspect_ratio_range (tuple of floats): Optional, the cropped area of the
                            image must have an aspect ratio = width / height within this range.
        area_range (tuple of floats): Optional, the cropped area of the image
                            must contain a fraction of the supplied image within in this range.
        max_attempts (int): An optional `int`. Number of attempts at generating a cropped
                            region of the image of the specified constraints. After `max_attempts`
                            failures, return the entire image.
        scope (str): String for name scope.
    Returns:
